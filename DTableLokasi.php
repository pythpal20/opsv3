          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                ...
                <p class="card-category">List Data Lokasi</p>
              </div>
              <div class="card-body">
                <form class="justify-content-end col-md-4" method="post" action="">
                  ...
                  <?php
                    if (isset($_POST['kode'])) {
                      ...
                      for ($i=0; $i < count($kode) ; $i++){
                        $query0="DELETE FROM masterlokasi WHERE lok_ID='$kode[$i]'";
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        $query="SELECT * FROM masterlokasi WHERE lok_ID LIKE ? OR lokasi LIKE ? ORDER BY lok_ID DESC";
                        $snc = $db1->prepare($query);
                        $snc->bind_param('ss', $search_keyword, $search_keyword);
                        $snc->execute();
                        $res1 = $snc->get_result();
                        ...
                        $query1="SELECT * FROM masterlokasi 
                        WHERE lok_ID LIKE ? OR lokasi LIKE ? ORDER BY lok_ID
                      ...
                      ?>
                      <tr>
                        <td><input class="checkbox" name="kode[]" type="checkbox" value="<?php  echo $row['lok_ID']; ?>"/></td>
                        <td><?php echo $id; ?></td>
                        <td><?php echo $lok; ?></td>
                        <td><?php echo $ket; ?></td>
                      </tr>
