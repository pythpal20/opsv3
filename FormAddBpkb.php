...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php
      $query = "SELECT MAX(bpkb_ID) as idArr FROM masterbpkb"; 
      $snc1 = $db1->prepare($query); 
      $snc1->execute();
      $res1 = $snc1->get_result();
      while ($row = $res1->fetch_assoc()) {
        $IdBpkb  = $row['idArr'];
        $urutan = (int) substr($IdBpkb, 3, 3);
        $urutan++;
        $huruf = "BP"; //singkatan dari Alat :)
        $hurufBack = "SNC"; //singkatan dari Seneca 
        $IdBpkb = $huruf . sprintf("%03s", $urutan) . $hurufBack; //ini yang bakal jadi kode otomatis ya
      }
    ?>
    <div class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Tambah BPKB</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="AddBpkbProses.php">
                  <div class="row">
                    <table class="table table-responsive">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="id" value="<?php echo $IdBpkb; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                            ...
                            <div class="form-group">
                              ...
                              <select name="title" id="NoPol" class="form-control" onChange="changeValue(this.value)">
                                ...
                                <?php
                                  ...
                                  WHERE NOT EXISTS (SELECT * FROM masterbpkb WHERE mk.KodeAlat = masterbpkb.KodeAlat)
                        ...
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="Bpkbnama">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <select name="tahun" id="tahun" class="form-control">
                                <option selected="selected" value="<?php echo $row['tahun']; ?>">Pilih Tahun <?php echo $row['tahun']; ?></option>
                                <?php
                      ...
                      <tr>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">Posisi BPKB</label>
                              <select name="posisiBpkb" class="form-control">
