...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php
      $query = "SELECT MAX(kir_ID) as idArr FROM masterkir"; 
      $snc1 = $db1->prepare($query); 
      $snc1->execute();
      $res1 = $snc1->get_result();
      while ($row = $res1->fetch_assoc()) {
        $IdKir  = $row['idArr'];
        $urutan = (int) substr($IdKir, 3, 3);
        $urutan++;
        $huruf = "KR"; //singkatan dari Alat :)
        $hurufBack = "SNC"; //singkatan dari Seneca 
        $IdKir = $huruf . sprintf("%03s", $urutan) . $hurufBack; //ini yang bakal jadi kode otomatis ya
      }
    ?>
    <div class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Tambah KIR</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="AddKirProses.php">
                  <div class="row">
                    <table class="table table-responsive">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="id" value="<?php echo $IdKir; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                            ...
                            <div class="form-group">
                              ...
                              <select name="title" id="NoPol" class="form-control" onChange="changeValue(this.value)">
                                ...
                                <?php
                                  ...
                                  WHERE NOT EXISTS (SELECT * FROM masterkir WHERE mk.KodeAlat = masterkir.KodeAlat)
                                  ORDER BY mk.KodeAlat ASC"; 
                      ...
                      <tr>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">No Mesin KIR</label>
                              <input type="text" class="form-control" name="NoMsnKir">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              <label class="bmd-label-floating">Tanngal KIR</label>
                              <input type="date" class="form-control" name="tglKir">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">Posisi KIR</label>
                              <select name="posisiKir" class="form-control">
