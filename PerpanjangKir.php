          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Perpanjangan KIR</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/PerpanjangProsesKir.php">
                  <div class="row">
                    <table class="table table-responsive">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">ID KIR</label>
                              <input type="text" class="form-control" name="id" value="<?php echo $row['kir_ID']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoMsnKir" value="<?php echo $row['NoMsnKir']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">Lokasi KIR</label>
                              <input type="text" class="form-control" name="NoMsnKir" value="<?php echo $row['KirPosisi']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td colspan=" 4">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="bmd-label-floating">Tanggal KIR</label>
                              <input type="date" class="form-control" name="tglKir" value="<?php echo $row['tgl_kir']; ?>" >
                            </div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <a class="btn btn-warning pull-right" href="UTableKir.php">Batal</a>
