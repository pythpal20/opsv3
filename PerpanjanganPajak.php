          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Perpanjangan Pajak</h4>
                <p class="card-category">Isi form dengan benar sesuai yang tertera pada STNK</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/PerpanjangProsesPajak.php">
                  <div class="row">
                    ...
                    <a class="btn btn-warning pull-right" href="UTablePajak.php">Batal</a>
