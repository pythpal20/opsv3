          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Data KIR Bulan ini</h4>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive" id="TableStnk">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mkr.KirPosisi LIKE ?) ORDER BY selisih ASC";
                        ...
                        if ($res1->num_rows > 0) {
                          while ($row = $res1->fetch_assoc()) {
                            ...
                            $selisih = $row['selisih'];
                      ?>
                      <?php if ($selisih > 0 AND $selisih < 30) { ?>
                      <tr>
                        ...
                        <td class="table-warning"><?php echo $selisih; ?> Hari lagi</td> 
                      ...
                      <?php } if ($selisih < 7 AND $selisih > 0) { ?>
                      <tr>
                        <td><?php echo $nomor++; ?></td>
                        <td><?php echo $id;?> </td>
                        <td><?php echo $nopol;?> </td>
                        ...
                        <td><?php echo $lokir; ?></td>
                        <td><?php echo $tglkir;?> </td>
                        <td class="table-danger"><?php echo abs($selisih); ?> Hari lagi</td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjangKir.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                  ...
                  <a class="btn btn-warning" href="MastengKir.php">KIR Lewat Masa tenggang</a>
                  <nav aria-label="...">
