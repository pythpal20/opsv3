...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php 
      $id = $_GET['id'];
      $query = "SELECT * FROM masterbpkb mb
        JOIN masterkendaraan mk ON mb.KodeAlat = mk.KodeAlat
        JOIN masterjeniskendaraan mjk ON mk.jenis_ID = mjk.jenis_ID
      WHERE mb.KodeAlat = '$id'";
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Ubah BPKB</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/UpdateBpkbProses.php">
                  <div class="row">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">ID BPKB</label>
                              <input type="text" class="form-control" name="id" value="<?php echo $row['bpkb_ID']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="nobpkb" value="<?php echo $row['nobpkb'];?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="Bpkbnama" value="<?php echo $row['bpkb_nama']; ?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <select name="tahun" id="tahun" class="form-control">
                                <option selected="selected" value="<?php echo $row['bpkb_tahun']; ?>">Pilih Tahun</option>
                                <?php
                          ...
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <select name="posisiBpkb" class="form-control">
                                <option value="<?php echo $row['bpkb_posisi']; ?>">Pilih Posisi</option>
                    ...
                    <a class="btn btn-warning pull-right" href="TableBpkb.php">Batal</a>
