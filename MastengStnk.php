          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Data STNK yang sudah lewat masa tenggang </h4>
                <p class="card-category">Silahkan Update Tanggal STNK setelah melakukan perpanjangan</p>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive" id="TableStnk">
                  <table class="table table-bordered">
                    <thead class=" text-primary text-center">
                      ...
                      <th><a class="column_sort" id="TglPajak" data-order="desc" href="#">Tanggal STNK</th>
                        <th>Masa tenggang</th>
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        $query="SELECT mk.KodeAlat, mk.NoPol, mjk.JenisKendaraan, mk.merk, ml.lokasi, ms.MasaBerlaku, DATEDIFF(ms.MasaBerlaku, CURRENT_DATE()) AS selisih
                        FROM masterstnk ms
                        ...
                        $query1="SELECT mk.KodeAlat, mk.NoPol, mjk.JenisKendaraan, mk.merk, ml.lokasi, ms.MasaBerlaku, DATEDIFF(ms.MasaBerlaku, CURRENT_DATE()) AS selisih
                        FROM masterstnk ms
                          JOIN masterkendaraan mk ON ms.KodeAlat=mk.KodeAlat
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                          JOIN masterlokasi ml ON mk.lok_ID = ml.lok_ID
                      ...
                      <tr>
                        ...
                        <td><?php echo $merk;?> </td>
                        <td><?php echo $lok; ?></td>
                        <td><?php echo $tglstnk;?> </td>
                        <td class="table-danger">Lewat <?php echo abs($sisa); ?> Tahun</td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjangStnk.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                        </td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td><?php echo $lok; ?></td>
                        <td><?php echo $tglstnk;?> </td>
                        <td class="table-danger">Lewat <?php echo abs($sisa); ?> Bulan <?php echo abs($hari); ?></td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjangStnk.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                  ...
                  <a class="btn btn-info" href="UTableStnk.php">STNK Bulan ini</a>
                  <nav aria-label="...">
