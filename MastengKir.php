          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Data KIR Yang sudah lewat masa tenggang</h4>
                <p class="card-category">Silahkan Update Tanggal KIR setelah melakukan perpanjangan</p>
              </div>
              <div class="card-body">
                    ...
                    <div class="col-sm-3">
                      <div class="input-group">
                        <select name="s_Lok" id="s_Lok" class="form-control" placeholder="Filter Lokasi">
                          ...
                          <?php
                            $SQLquery = "SELECT DISTINCT lokasi
                            FROM masterlokasi ORDER BY lokasi DESC";
                            $snc = $db1->prepare($SQLquery);
                            $snc -> execute();
                            $resl = $snc->get_result();
                ...
                <div class="table-responsive" id="TableStnk">
                  <table class="table table-bordered">
                    <thead class=" text-primary text-center">
                      <th>No</th>
                      <th><a class="column_sort" id="KodeAlat" data-order="desc" href="#">Kode Alat</a></th>
                      <th><a class="column_sort" id="mk.NoPol" data-order="desc" href="#">No Polisi</th>
                      <th><a class="column_sort" id="mjk.JenisKendaraan" data-order="desc" href="#">Jenis</a></th>
                      <th><a class="column_sort" id="mk.merk" data-order="desc" href="#">Merk</a></th>
                      <th><a class="column_sort" id="ml.lokasi" data-order="desc" href="#">Lokasi Kendaraan</a></th>
                      <th><a class="column_sort" id="NoMsnKir" data-order="desc" href="#">No Mesin KIR</a></th>
                      <th><a class="column_sort" id="KirPosisi" data-order="desc" href="#">Posisi KIR</a></th>
                      <th><a class="column_sort" id="tgl_kir" data-order="desc" href="#">Tanggal KIR</th>
                        <th>Masa tenggang</th>
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        $query="SELECT mk.KodeAlat, mk.NoPol, mjk.JenisKendaraan, mk.merk, ml.lokasi, mkr.tgl_kir, DATEDIFF(mkr.tgl_kir, CURRENT_DATE()) AS selisih, mkr.KirPosisi, mkr.NoMsnKir
                        FROM masterkir mkr
                          JOIN masterkendaraan mk ON mkr.KodeAlat=mk.KodeAlat
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                          JOIN masterlokasi ml ON mk.lok_ID = ml.lok_ID
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mkr.KirPosisi LIKE ?) ORDER BY selisih DESC";
                        ...
                        $query1="SELECT mk.KodeAlat, mk.NoPol, mjk.JenisKendaraan, mk.merk, ml.lokasi, mkr.tgl_kir, DATEDIFF(mkr.tgl_kir, CURRENT_DATE()) AS selisih, mkr.KirPosisi, mkr.NoMsnKir
                        FROM masterkir mkr
                          JOIN masterkendaraan mk ON mkr.KodeAlat=mk.KodeAlat
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                          JOIN masterlokasi ml ON mk.lok_ID = ml.lok_ID
                        ...
                        if ($res1->num_rows > 0) {
                          while ($row = $res1->fetch_assoc()) {
                            ...
                            $selisih = $row['selisih'];
                      ?>
                      <?php if ($selisih < 0 AND $selisih < (-365) ) { 
                        $sisa = intval($selisih/365);
                        $habis = $selisih % 30;
                      ?>
                      <tr>
                        ...
                        <td class="table-danger">Lewat <?php echo abs($sisa); ?> Tahun <?php echo abs($habis); ?> Hari</td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjangKir.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                        </td>
                      </tr>
                      <?php } if ($selisih > -365 AND $selisih < 0  ) { 
                        $sisa = intval($selisih/30);
                        $hari = $selisih % 30;
                      ?>
                      <tr>
                        <td><?php echo $nomor++; ?></td>
                        ...
                        <td class="table-danger">
                          Lewat <?php echo abs($sisa); ?> Bulan <?php echo abs($hari); ?> hari
                        </td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjangKir.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                      ...
                      <?php } } else { ?>
                      <tr>
                        <td colspan='10'>Data bulan ini Kosong!</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
                  <a class="btn btn-info" href="UTableKir.php">KIR Bulan Ini</a>
                  <nav aria-label="...">
