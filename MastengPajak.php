          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Data Pajak Yang sudah lewat masa tenggang</h4>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive" id="TableStnk">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="table-danger">Lewat <?php echo abs($sisa); ?> Tahun</td> 
                      ...
                      <tr>
                        ...
                        <td><?php echo $lok; ?></td>
                        <td><?php echo $tglPajak;?> </td>
                        <td class="table-danger">Lewat <?php echo abs($sisa); ?> Bulan <?php echo abs($hari); ?> hari</td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjanganPajak.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                  ...
                  <a class="btn btn-info" href="UTablePajak.php">Pajak Bulan Ini</a>
                  <nav aria-label="...">
