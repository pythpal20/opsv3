        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="update/UpdateUserProses.php">
                  <div class="row">
                    <table class="table table-responsive">
                        ...
                        <td>
                          <div class="col-md-15">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="jbtn" value="<?php echo $row['jabatan']; ?>" >
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class="col-md-20">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="password" placeholder="isi password baru">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <select class="form-control dropdown" name="lvl" id="level">
                      ...
                      <tr>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">Akses Create</label>
                              <select class="form-control dropdown" name="crt" id="create">
                                <option value="<?php echo $row['akses_create']; ?>">Pilih Akses</option>
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">Akses Update</label>
                              <select class="form-control dropdown" name="upd" id="update">
                                <option value="<?php echo $row['akses_update']; ?>">Pilih Akses</option>
                                <option value="ya">Ya</option>
                                <option value="tidak">Tidak</option>
                              </select>
                            </div>
                        ...
                        <td>
                          <div class="col-md-15">
                            <div class="form-group">
                              <label class="bmd-label-floating">Akses Delete</label>
                              <select class="form-control dropdown" name="dlt" id="delete">
                                <option value="<?php echo $row['akses_delete']; ?>">Pilih Akses</option>
                                <option value="ya">Ya</option>
                                <option value="tidak">Tidak</option>
                              </select>
                            </div>
                    ...
                    <a class="btn btn-warning pull-right" href="TableUser.php">Batal</a>
