          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                ...
                <p class="card-category">List Data Kendaraan</p>
              </div>
              <div class="card-body">
                      ...
                      <div class="input-group">
                        <select name="s_Lok" id="s_Lok" class="form-control" placeholder="Filter Lokasi">
                          ...
                          <?php
                            ...
                            $snc -> execute();
                            $resl = $snc->get_result();
                            while ($dt = $resl->fetch_assoc()) {
                              echo '<option value="'.$dt['lokasi'].'">'.$dt['lokasi'].'</option>';
                            }
                          ?>
                        </select>
                      </div>
                  ...
                  <?php
                    if (isset($_POST['kode'])) {
                      ...
                      for ($i=0; $i < count($kode) ; $i++){
                        $query0="DELETE FROM masterkendaraan WHERE KodeAlat='$kode[$i]'";
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mk.kondisi LIKE ?) ORDER BY mk.KodeAlat ASC";
                        ...
                        $query1="SELECT * FROM masterkendaraan mk
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                          JOIN masterlokasi ml ON mk.lok_ID=ml.lok_ID
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mk.kondisi LIKE ?) ORDER BY mk.KodeAlat
                      ...
                      ?>
                      <tr>
                        <td><input class="checkbox" name="kode[]" type="checkbox" value="<?php  echo $row['KodeAlat']; ?>"/></td>
                        <td><?php echo $id;?> </td>
