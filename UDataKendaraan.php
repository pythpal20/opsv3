          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Update Kendaraan</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/UDataKenProses.php">
                  <div class="row">
                        ...
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoPol" value="<?php echo $row['JenisKendaraan']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                        <td>
