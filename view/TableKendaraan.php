          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Kendaraan Jalan</h4>
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mk.ktr LIKE ?) AND mk.kondisi='$Kon' ORDER BY mk.KodeAlat ASC";
                        ...
                        $query1="SELECT * FROM masterkendaraan mk
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                          JOIN masterlokasi ml ON mk.lok_ID=ml.lok_ID
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mk.ktr LIKE ?) AND mk.kondisi='$Kon' ORDER BY mk.KodeAlat
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                          <a title="Ubah" rel="tooltip" href="../UpdateKendaraan.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a> | <?php endif ?>
                          <?php if($data['akses_delete'] == 'ya') : ?>
                          <a title="Hapus" rel="tooltip" href="../dlt/DeleteKendaraan.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">remove_circle</i></a> <?php endif ?>
                        </td>
                      </tr>
                      <?php } } else { ?>
                      <tr>
                  ...
                  <a class="btn btn-info" href="../FormAddKendaraan.php">+ Tambah Kendaraan</a>
                  <?php endif; ?>
                  <nav aria-label="...">
