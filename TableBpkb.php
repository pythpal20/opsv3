          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Data BPKB</h4>
                <p class="card-category">List BPKB</p>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        WHERE mb.bpkb_posisi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mb.bpkb_nama LIKE ?) ORDER BY mk.KodeAlat ASC";
                        ...
                        $query1="SELECT * FROM masterbpkb mb
                          JOIN masterkendaraan mk ON mb.KodeAlat=mk.KodeAlat
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                        WHERE mb.bpkb_posisi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR mb.bpkb_nama LIKE ?) ORDER BY mk.KodeAlat
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                          <a title="Ubah" rel="tooltip" href="UpdateBpkb.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a> | <?php endif ?>
                          <?php if($data['akses_delete'] == 'ya') : ?>
                          <a title="Hapus" rel="tooltip" href="dlt/DeleteBpkb.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">remove_circle</i></a> <?php endif ?>
                        </td>
                      </tr>
                      <?php } } else { ?>
                      <tr>
                  ...
                  <a class="btn btn-info" href="FormAddBpkb.php">+ Tambah BPKB</a>
                  <?php endif; ?>
                  <nav aria-label="...">
