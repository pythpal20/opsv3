          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                ...
                <p class="card-category">Pilih data user dan klik Hapus</p>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive" id="TableUser">
                  <?php
                    if (isset($_POST['kode'])) {
                      ...
                      for ($i=0; $i < count($kode) ; $i++){
                        $query0="DELETE FROM user WHERE user_ID='$kode[$i]'";
                        $snc = $db1->prepare($query0);
                        $snc->execute();
                        $res1 = $snc->get_result();
                      }
                    }
                  ...
                  <table class="table table-bordered">
                    <thead class=" text-primary">
                      <tr>
                        <th rowspan="2">
                          <script> function toggle(pilih) { checkboxes = document.getElementsByName('kode[]');
                          for(var i=0, n=checkboxes.length;i<n;i++)
                          { checkboxes[i].checked = pilih.checked; } } </script>
                          <input class="checkbox" onClick="toggle(this)" type="checkbox" value="">
                        </th>
                        <th rowspan="2"><a class="column_sort" id="user_ID" data-order="desc" href="#">ID</a></th>
                        <th rowspan="2"><a class="column_sort" id="nama" data-order="desc" href="#">Nama</a></th>
                        <th rowspan="2"><a class="column_sort" id="jabatan" data-order="desc" href="#">Jabatan</a></th>
                        <th rowspan="2"><a class="column_sort" id="username" data-order="desc" href="#">Username</a></th>
                        <th rowspan="2"><a class="column_sort" id="level" data-order="desc" href="#">Level User </a></th>
                        <th colspan="3" class="text-center">Akses</th>
                      </tr>
                      <tr>
                        <th><a class="column_sort" id="akses_create" data-order="desc" href="#">Create</a></th>
                        <th><a class="column_sort" id="akses_update" data-order="desc" href="#">Update</a></th>
                        <th><a class="column_sort" id="akses_delete" data-order="desc" href="#">Delete</a></th>
                      </tr>
                    </thead>
                    <tbody>
                    <?php    //ini mah PHP, kita pake object
                      ...
                      ?>
                      <tr>
                        <td><input class="checkbox" name="kode[]" type="checkbox" value="<?php  echo $row['user_ID']; ?>"/></td>
                        <td><?php echo $id; ?></td>
                        <td><?php echo $nama; ?></td>
                  ...
                  <button type="submit"  class="btn btn-danger float-right"><i class="material-icons">delete</i> Hapus</button>
                  </form>
                  <nav aria-label="...">
