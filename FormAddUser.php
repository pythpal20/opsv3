...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php
    $query = "SELECT MAX(user_ID) as idArr FROM user"; 
    $snc1 = $db1->prepare($query); 
    $snc1->execute();
    $res1 = $snc1->get_result();
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="AddUserProses.php">
                  <div class="row">
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="bmd-label-floating">Id</label>
                        <input type="text" class="form-control" name="id" value="<?php echo $IdUser; ?>" readonly>
                      </div>
                    </div>
                    <div class="col-md-5">
                      <div class="form-group">
                    ...
                    <div class="col-md-5">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jbtn">
                      </div>
                    </div>
                    <div class="col-md-3">
                      <div class="form-group">
