...
<head>
  ...
  <title>
    Data Jenis kendaraan | PT. SENECA IND
  </title>
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                ...
                <p class="card-category">List Data Jenis Kendaraan</p>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered">
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        $query="SELECT * FROM masterjeniskendaraan WHERE jenis_ID LIKE ? OR JenisKendaraan LIKE ? ORDER BY jenis_ID DESC";
                        ...
                        $query1="SELECT * FROM masterjeniskendaraan 
                        WHERE jenis_ID LIKE ? OR JenisKendaraan LIKE ? ORDER BY jenis_ID
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                          <a title="Ubah" rel="tooltip" href="UpdateJenis.php?id=<?php echo $row['jenis_ID']; ?>"><i class="material-icons">create</i></a> | <?php endif ?>
                          <?php if($data['akses_delete'] == 'ya') : ?>
                          <a title="Hapus" rel="tooltip" href="dlt/DeleteJenis.php?id=<?php echo $row['jenis_ID']; ?>"><i class="material-icons">remove_circle</i></a> <?php endif ?>
                        </td>
                      </tr>
                      <?php } } else { ?>
                      <tr>
                  ...
                  <a class="btn btn-info" href="FormAddJenis.php">+ Tambah Jenis</a>
                  <?php endif; ?>
                  <nav aria-label="...">
