            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <div class="table-responsive">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <?php if($data['akses_update']== 'ya') : ?>
                          <a title="Ubah" rel="tooltip" href="UpdateLokasi.php?id=<?php echo $row['lok_ID']; ?>"><i class="material-icons">create</i></a> <?php endif ?> | 
                          <?php if($data['akses_delete']=='ya') : ?>
                          <a title="Hapus" rel="tooltip" href="dlt/DeleteLokasi.php?id=<?php echo $row['lok_ID']; ?>"><i class="material-icons">remove_circle</i></a> <?php endif ?>
                        </td>
                      </tr>
                      <?php } } else { ?>
                      <tr>
                  ...
                  <a class="btn btn-info" href="FormAddLokasi.php">+ Tambah Lokasi</a>
                  <?php endif; ?>
                  <nav aria-label="...">
