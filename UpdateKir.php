          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Ubah KIR</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/UpdateKirProses.php">
                  <div class="row">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoMsnKir" value="<?php echo $row['NoMsnKir']; ?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          ...
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <select name="posisiKir" class="form-control">
                                <option value="<?php echo $row['KirPosisi']; ?>">Pilih Posisi</option>
                    ...
                    <a class="btn btn-warning pull-right" href="TableKir.php">Batal</a>
