          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Ubah STNK</h4>
                <p class="card-category">Isi form dengan benar</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/UpdateStnkProses.php">
                  <div class="row">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">ID STNK</label>
                              <input type="text" class="form-control" name="id" value="<?php echo $row['stnk_ID']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="KodeAlat" value="<?php echo $row['KodeAlat']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoPol" value="<?php echo $row['NoPol']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-14">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="JnsKen" value="<?php echo $row['JenisKendaraan']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-14">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="merk" value="<?php echo $row['merk']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="date" class="form-control" name="MasaBerlaku" value="<?php echo $row['MasaBerlaku'];?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-15">
                            <div class="form-group">
                              <label class="bmd-label-floating">Tanggal Pajak</label>
                              <input type="date" class="form-control" name="TglPajak" value="<?php echo $row['TglPajak']; ?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <select name="PosisiStnk" class="form-control">
                                <option value="<?php echo $row['PosisiStnk']; ?>">Pilih Posisi</option>
                        ...
                        <td>
                          <div class="col-md-15">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoRak" value="<?php echo $row['NoRangka']; ?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoMsn" value="<?php echo $row['NoMesin']; ?>">
                            </div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <a class="btn btn-warning pull-right" href="TableStnk.php">Batal</a>
