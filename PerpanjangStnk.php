          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title">Form Perpanjangan STNK</h4>
                <p class="card-category">Isi form dengan benar sesuai yang tertera pada STNK</p>
              </div>
              <div class="card-body">
                <form method="post" action="update/PerpanjangProsesStnk.php">
                  <div class="row">
                    <table class="table table-responsive">
                      ...
                      <tr>
                        ...
                        <td>
                          <div class="col-md-14">
                            <div class="form-group">
                              <label class="bmd-label-floating">Lokasi Kendaraan</label>
                              <input type="text" class="form-control" name="lok" value="<?php echo $row['lokasi']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                      <tr>
                        <td colspan="4">
                          <div class="col-md-3">
                            <div class="form-group">
                              <label class="bmd-label-floating">Masa Berlaku STNK</label>
                    ...
                    <a class="btn btn-warning pull-right" href="UTableStnk.php">Batal</a>
