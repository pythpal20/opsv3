...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php
      $query = "SELECT MAX(jenis_ID) as idArr FROM masterjeniskendaraan"; 
      $snc1 = $db1->prepare($query); 
      $snc1->execute();
      $res1 = $snc1->get_result();
      while ($row = $res1->fetch_assoc()) {
        ...
        $urutan++;
        $huruf = "ALT"; //singkatan dari Alat :)
        $hurufBack = "SNC"; //singkatan dari Seneca 
        $IdJns = $huruf . sprintf("%03s", $urutan) . $hurufBack; //ini yang bakal jadi kode otomatis ya
      }
    ?>
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="AddJenisProses.php">
                  <div class="row">
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="bmd-label-floating">ID</label>
                        <input type="text" class="form-control" name="id" value="<?php echo $IdJns; ?>" readonly>
                      </div>
                    </div>
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="bmd-label-floating">Jenis kendaraan</label>
                        <input type="text" class="form-control" name="JnsKen">
                      </div>
                    </div>
