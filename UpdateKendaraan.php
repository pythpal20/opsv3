...
<head>
  ...
  <title>
    Update Kendaraan | PT. SENECA IND
  </title>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="update/UpdateKendaraanProses.php">
                  <div class="row">
                    <table class="table table-responsive">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="id" value="<?php echo $row['KodeAlat']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" name="NoPol" value="<?php echo $row['NoPol']; ?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-18">
                            <div class="form-group">
                              ...
                              <select name="JnsKen" class="form-control">
                                <option value="<?php echo $row['jenis_ID'];?>">Pilih Jenis Kendaraan</option>
                                <?php
                      ...
                      <tr>
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">Kondisi</label>
                              <input type="text" class="form-control" name="kondisi" value="<?php echo $row['kondisi']; ?>">
                            </div>
                          </div>
                        </td>
                        <td>
                          <div class="col-md-15">
                            <div class="form-group">
                              <label class="bmd-label-floating">Posisi Kendaraan</label>
                              <select name="posisi" class="form-control">
                                <option value="<?php echo $row['lok_ID']; ?>">Pilih Lokasi</option>
                                <?php
                        ...
                        <td>
                          <div class="col-md-20">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="keterangan" ><?php echo $row['ktr']; ?></textarea>
                            </div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <a class="btn btn-warning pull-right" href="TableKendaraan.php">Batal</a>
