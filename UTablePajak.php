          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-info">
                <h4 class="card-title ">Tabel Data Pajak Bulan ini</h4>
                <p class="card-category">Silahkan Update Tanggal Pajak setelah melakukan perpanjangan</p>
              </div>
              <div class="card-body">
                ...
                <div class="table-responsive" id="TableStnk">
                  <table class="table table-bordered">
                    <thead class=" text-primary text-center">
                      ...
                      <th><a class="column_sort" id="TglPajak" data-order="desc" href="#">Tanggal Pajak</th>
                        <th>Masa tenggang</th>
                    ...
                    <tbody>
                      <?php    //ini mah PHP, kita pake object
                        ...
                        $query="SELECT mk.KodeAlat, mk.NoPol, mjk.JenisKendaraan, mk.merk, ml.lokasi, ms.TglPajak, DATEDIFF(ms.TglPajak, CURRENT_DATE()) AS selisih
                        FROM masterstnk ms
                        ...
                        WHERE ml.lokasi LIKE ? AND (mk.KodeAlat LIKE ? OR mk.NoPol LIKE ? OR mk.merk LIKE ? OR mjk.JenisKendaraan LIKE ? OR ms.stnk_ID LIKE ?) ORDER BY selisih ASC";
                        ...
                        $query1="SELECT mk.KodeAlat, mk.NoPol, mjk.JenisKendaraan, mk.merk, ml.lokasi, ms.TglPajak, DATEDIFF(ms.TglPajak, CURRENT_DATE()) AS selisih
                        FROM masterstnk ms
                          JOIN masterkendaraan mk ON ms.KodeAlat=mk.KodeAlat
                          JOIN masterjeniskendaraan mjk ON mk.jenis_ID=mjk.jenis_ID
                          JOIN masterlokasi ml ON mk.lok_ID = ml.lok_ID
                      ...
                      <tr>
                        ...
                        <td><?php echo $id;?> </td>
                        <td><a href="UTableStnk.php?id=<?php echo $row['KodeAlat']; ?>"><?php echo $nopol;?></a></td>
                        <td><?php echo $JeKen;?> </td>
                        <td><?php echo $merk;?> </td>
                        <td><?php echo $lok; ?></td>
                        <td><?php echo $tglpajak;?> </td>
                        <td class="table-warning"><?php echo $selisih; ?> Hari lagi</td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjanganPajak.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                        </td>
                      </tr>
                      <?php } if ($selisih < 7 AND $selisih > 30) { ?>
                      <tr>
                        <td><?php echo $nomor++; ?></td>
                        <td><?php echo $id;?> </td>
                        <td><a href="UTableStnk.php?id=<?php echo $row['KodeAlat']; ?>"><?php echo $nopol;?></a></td>
                        ...
                        <td><?php echo $lok; ?></td>
                        <td><?php echo $tglpajak;?> </td>
                        <td class="table-danger"><?php echo abs($selisih); ?> Hari</td> 
                        <td class="text-center">
                          <?php if($data['akses_update'] == 'ya') : ?>
                            <a title="Ubah" rel="tooltip" href="PerpanjanganPajak.php?id=<?php echo $row['KodeAlat']; ?>"><i class="material-icons">create</i></a>
                          <?php endif ?>
                      ...
                      <?php } } } else { ?>
                      <tr>
                        <td colspan='10'>Data bulan ini Kosong!Cek Stnk Lewat masa tenggang</td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
                  <a class="btn btn-warning" href="MastengPajak.php">Pajak Lewat Masa tenggang</a>
                  <nav aria-label="...">
