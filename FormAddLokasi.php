...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php
      $query = "SELECT MAX(lok_ID) as idArr FROM masterlokasi"; 
      $snc1 = $db1->prepare($query); 
      $snc1->execute();
      $res1 = $snc1->get_result();
      while ($row = $res1->fetch_assoc()) {
        $IdLok  = $row['idArr'];
        $urutan = (int) substr($IdLok, 3, 3);
        $urutan++;
        $huruf = "LOC";
        $hurufBack = "SNC";
        $IdLok = $huruf . sprintf("%03s", $urutan) . $hurufBack;
      }
    ?>
    <div class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="AddLokasiProses.php">
                  <div class="row">
                    <div class="col-md-2">
                      <div class="form-group">
                        <label class="bmd-label-floating">ID</label>
                        <input type="text" class="form-control" name="id" value="<?php echo $IdLok; ?>" readonly>
                      </div>
                    </div>
                    <br>
                    <div class="col-md-4">
