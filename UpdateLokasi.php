...
<div class="wrapper">
  ...
  <div class="main-panel">
    ...
    <?php 
      $id = $_GET['id'];
      $query = "SELECT * FROM masterlokasi
      WHERE lok_ID = '$id'";
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="post" action="update/UpdateLokasiProses.php">
                  <div class="row">
                        ...
                        <td>
                          <div class="col-md-10">
                            <div class="form-group">
                              <label class="bmd-label-floating">ID Lokasi</label>
                              <input type="text" class="form-control" name="id" value="<?php echo $row['lok_ID']; ?>" readonly>
                            </div>
                          </div>
                        </td>
                      </tr>
                        ...
                        <td>
                          <div class="col-md-20">
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="ket"><?php echo $row['keterangan']; ?></textarea>
                            </div>
                          </div>
                        </td>
                      </tr>
                    ...
                    <a class="btn btn-warning pull-right" href="TableLokasi.php">Batal</a>
