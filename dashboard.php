              ...
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <?php if($data['level'] == 'admin') : ?>
                    <a href="TableUser.php">Tampilkan data user</a>
                    <?php endif; ?>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info card-header-icon">
                  ...
                  <h3 class="card-title">
                  <?php
                    $query = "SELECT COUNT(KodeAlat) AS jlh FROM masterkendaraan"; 
                    $snc = $db1->prepare($query); 
                    $snc->execute();
                    $res1 = $snc->get_result();
                    while ($row = $res1->fetch_assoc()) {
                ...
                <div class="card-footer">
                  <div class="stats">
                    ...
                    <a href="TableKendaraan.php">Tampilkan data Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">Kendaraan Jalan</p>
                  <h3 class="card-title">
                  <?php
                    $query = "SELECT COUNT(KodeAlat) AS jlh FROM masterkendaraan Where kondisi = 'jalan' "; 
                    $snc = $db1->prepare($query); 
                    $snc->execute();
                    $res1 = $snc->get_result();
                    while ($row = $res1->fetch_assoc()) {
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">list</i>
                    <a href="view/TableKendaraan.php?kon=jalan">Tampilkan data Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h3 class="card-title">
                  <?php
                    $query = "SELECT COUNT(KodeAlat) AS jlh FROM masterkendaraan Where kondisi = 'rusak' "; 
                    $snc = $db1->prepare($query); 
                    $snc->execute();
                    $res1 = $snc->get_result();
                    while ($row = $res1->fetch_assoc()) {
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">list</i>
                    <a href="view/TableKendaraan.php?kon=rusak">Tampilkan data Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-5 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category font-weight-bold" >Pajak dalam Masa tenggang bulan ini</p>
                  <h3 class="card-title">
                  <?php
                  error_reporting(0);
                    $qry = "SELECT * 
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">list</i>
                    <a href="UTablePajak.php">Tampilkan data Pajak Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-5 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category font-weight-bold">Pajak Lewat Masa tenggang</p>
                  <h3 class="card-title">
                  <?php
                  error_reporting(0);
                    $sql = " SELECT *
                    FROM (SELECT DATEDIFF(TglPajak,CURRENT_DATE()) AS slh FROM masterstnk)AS PajakX
                    WHERE slh < 0 ";
                    $snc1 = $db1->prepare($sql); 
                    $snc1->execute();
                    $res1 = $snc1->get_result();
                      while ($row = $res1->fetch_assoc()) {
                        $dtx[]=$row;
                      }
                      $jumlah_data = count($dtx);
                  ?>
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">list</i>
                    <a href="MastengPajak.php">Tampilkan data Pajak Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-5 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category font-weight-bold">STNK dalam Masa tenggang bulan ini</p>
                  <h3 class="card-title">
                  <?php
                  error_reporting(0);
                    $query1 = " SELECT *
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">list</i>
                    <a href="UTableStnk.php">Tampilkan data STBK Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-lg-5 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <p class="card-category font-weight-bold">STNK Lewat Masa tenggang bulan ini</p>
                  <h3 class="card-title">
                  <?php
                  error_reporting(0);
                    $query2 = " SELECT *
                    FROM (SELECT DATEDIFF(MasaBerlaku,CURRENT_DATE()) AS jarak FROM masterstnk)AS stnkA
                    WHERE jarak < 0 ";
                    $snc1 = $db1->prepare($query2); 
                    $snc1->execute();
                    $res1 = $snc1->get_result();
                      while ($row = $res1->fetch_assoc()) {
                        $dtm[]=$row;
                      }
                      $jumlah_data = count($dtm);
                  ?>
                  <?php echo $jumlah_data; ?>
                  <small>Unit</small>
                  </h3>
                ...
                <div class="card-footer">
                  <div class="stats">
                    <i class="material-icons">list</i>
                    <a href="MastengStnk.php">Tampilkan data STBK Kendaraan</a>
                  </div>
                </div>
              </div>
            </div>
...
<!-- Ini ditulis dengan Native PHP tanpa Framework, hanya tambahan beberapa css dan Js
  - Bootstrap
